...
业务项目创建在（各设备路径见 `storage-policy.md`）：

```text
Mac NAS:    /Volumes/home/Drive/00_FileStation/YYMMDD-project-name/
Mac 同步:   ~/Library/CloudStorage/SynologyDrive-FileStation/YYMMDD-project-name/
