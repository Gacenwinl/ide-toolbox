...
按设备使用**推荐路径**（与 `config/project-policy.yaml` 一致）：

- MacBook Drive 同步：`~/Library/CloudStorage/SynologyDrive-FileStation/...`
- Mac mini NAS 挂载：`/Volumes/home/Drive/00_FileStation/...`
- Windows Git Bash：`C:/Users/13555/SynologyDrive/...`
